      ...
      <div className="min-h-screen bg-background">
        <header className="bg-card border-b sticky top-0 z-10">
          <div className="container mx-auto px-4 py-4 flex items-center gap-3">
            <Button variant="ghost" size="icon" onClick={() => setSelectedSalon(null)} aria-label="Back to salons" className="rounded-full">
              ←
            </Button>
            <button
              type="button"
              ...
              className="p-2 rounded-xl bg-primary/10 hover:scale-105 transition-transform shrink-0"
            >
              <Scissors className="w-5 h-5 text-primary" />
            </button>
            <div className="flex-1 min-w-0">
              <h1 className="text-xl font-bold text-foreground truncate">{selectedSalon.name}</h1>
